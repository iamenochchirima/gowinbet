...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
    ...
    const defaultColor = () => {
        const btn = {
            ...
            hoverColor: active
                ? ''
                : `ring-primary dark:ring-gray-500 hover:border-primary dark:hover:border-gray-500 hover:ring-1 hover:text-primary dark:hover:text-white dark:hover:bg-transparent`,
            activeColor: ``,
        }
        return getBtnColor(btn)
    }
