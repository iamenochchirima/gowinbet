...
const VerticalMenuContent = (props: VerticalMenuContentProps) => {
    ...
    return (
        <>
            ...
            <div className="px-4  flex-col gap-8"
             style={{ display: shouldHideButtons ? 'flex' : 'none' }}
            >
                <Link to="/dashboards/magic-radar">
                    <button className="bg-gray-700 w-full text-start hover:bg-gray-600 py-2 px-4 rounded-xl">
                        Top New Tokens
                    </button>
                </Link>
                <Link to="#">
