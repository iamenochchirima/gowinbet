...
const navigationIcon: NavigationIcons = {
    ...
    dashboardHome: <IoMdHome />,
    dashboardWatchlist: <TiStar />,
    dashboardProfile: <FaUser size={20}/>,
    dashboardMagicRadar: <HiRocketLaunch size={20} />,
    dashboardMagicDip: <HiRocketLaunch size={20} style={{ transform: 'rotate(90deg)' }} />,
    dashboardWatchVideos: <FaYoutube size={20}/>,
